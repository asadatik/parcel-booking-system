...
const userValidation_2 = require("./userValidation");
...
router.get("/all-user", (0, checkAuth_1.checkAuth)(user_interface_1.Role.ADMIN), user_controller_1.UserControllers.getAllUsers);
...
router.patch("/:id", (0, validateRequest_1.validateRequest)(userValidation_2.updateUserZodSchema), (0, checkAuth_1.checkAuth)(...Object.values(user_interface_1.Role)), user_controller_1.UserControllers.updateUser);
