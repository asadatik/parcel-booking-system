...
router.get("/my", (0, checkAuth_1.checkAuth)(user_interface_1.Role.SENDER), parcel_controller_1.ParcelControllers.getMyParcels);
...
router.patch("/:id/cancel", (0, validateRequest_1.validateRequest)(parcel_validations_1.updateParcelStatusZodSchema), (0, checkAuth_1.checkAuth)(user_interface_1.Role.SENDER), parcel_controller_1.ParcelControllers.cancelParcel);
